...
class OfferForm(ModelForm):
    salary_info = models.CharField(max_length=200, widget = forms.TextInput(attrs={'placeholder': 'Salary', 'style': 'width: 300px;', 'class': 'form-control'}))
    due_date = models.DateTimeField(widget=forms.DateTimeInput(attrs={'placeholder': 'Due Date (mm/dd/yyyy)', 'style': 'width: 300px;', 'class': 'form-control'}))
